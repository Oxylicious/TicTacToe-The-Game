# TicTacToe-The-Game by Charles Ivan M. Martin
# Just me alone lol
...
- Game Dependencies ✔
    ...
    if it didn't show up, you have to open the python directory from the 'AppData/Local/Programs/Python/Python312'
